...
created: "2018-06-20"
modified: "2018-06-20"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/aws-identity-and-access-management/apis.md
...
- name: AWS Identity and Access Management API Generate Credential Report
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/aws-identity-and-access-management/actiongeneratecredentialreport-get-openapi.md
- name: AWS Identity and Access Management API Get Credential Report
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/aws-identity-and-access-management/actiongetcredentialreport-get-openapi.md
- name: AWS Identity and Access Management API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/aws-identity-and-access-management/openapi.md
x-common:
- type: x-change-log
