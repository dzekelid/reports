...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/reports/master/_listings/akamai/sla-api-v1-tests-slatestid-reports-performance-start,end-get.md
x-common:
- type: x-base
