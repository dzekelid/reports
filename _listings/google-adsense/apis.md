...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/google-adsense/apis.md
...
- name: Google Adsense Merged API - Generate Report
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/google-adsense/accountsaccountidreports-get-openapi.md
- name: Google Adsense Merged API - Get Report
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/reports/master/_listings/google-adsense/reports-get-openapi.md
- name: Google Adsense Merged API - Generate Report
  x-api-slug: accountsaccountidreports-get
  description: Generate an AdSense report based on the report request sent in the
    query parameters. Returns the result as JSON; to retrieve output in CSV format
